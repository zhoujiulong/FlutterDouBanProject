...
class FindTvPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (_findTvBloc.newMovieListModel == null) {
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<LoadingState> snapshot) {
        ...
        return LoadingView(
          ...
          allRetryListener: () {
            _findTvBloc.setLoadingState(LoadingState.loading);
            _findTvBloc.getData();
          },
        );
      },
  ...
  Widget _buildWeeklyList() {
    return StreamBuilder(
        initialData: _findTvBloc.weeklyListModel,
  ...
  Widget _buildUsBoxList() {
    return StreamBuilder(
        initialData: _findTvBloc.usBoxListModel,
  ...
  Widget _buildList() {
    return StreamBuilder(
        initialData: _findTvBloc.newMovieListModel,
